...
*/
// BMH 2022-08-17   change for local configuration
//    lines 11, 150, 153, 154, 170, 244, 245, 246, 247, 248, 363, 392, 585, 595, 599

// BMH @setlocale(LC_TIME, ['en_US', 'en_US.utf8', 'en', 'English_United States.1252']);
...
$define = [
    ...
    // BMH 'ENTRY_DATE_OF_BIRTH_ERROR' => '&nbsp;<span class="errorText">(eg. 05/21/1970)</span>',
    'ENTRY_DATE_OF_BIRTH_ERROR' => '&nbsp;<span class="errorText">(eg. 21/05/1970)</span>', // BMH
    ...
    // BMH 'PHP_DATE_TIME_FORMAT' => 'm/d/Y H:i:s',
    'PHP_DATE_TIME_FORMAT' => 'd/m/Y H:i:s', // BMH
    ...
    'SITE_TAGLINE' => 'Classic Motorcycle Parts',       /* BMH  2022*/
    ...
    'TEXT_SORT_CATEGORIES_ID' => 'Categories ID', /* BMH 2022 */
    ...
    'TEXT_SORT_PRODUCTS_ID' => 'Products ID',   /* BMH 2022*/
