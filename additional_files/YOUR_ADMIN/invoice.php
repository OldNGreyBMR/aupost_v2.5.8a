 ...
 */
 // BMH 2024-12-22 ln74 Tax Invoice Title "TITLE_INVOICE"; ln121 check address for pickup
 //                 ln124 main-address fold; ln256; ln425
 //
        ...
        <tr>
          ...
          <td style="border: none">
            <table>
              <tr>
                <!-- BMH <td class="main"> -->
                <td class="main-ship-name"><b><?php echo ENTRY_SHIP_TO; ?></b></td>                  
              </tr>
              <tr>
                <!-- BMH <td class="main">  PICKUP ADDRESS --> 
                <td class="main-ship-name"><?php //echo (!empty($order->delivery) ? zen_address_format($order->delivery['format_id'], $order->delivery, 1, '', '<br>') : TEXT_NONE); 
                    if ($pickup != true){
...
<?php
          ...
          //
          $extra_headings = false;
          $zco_notifier->notify('NOTIFY_ADMIN_INVOICE_HEADERS_AFTER_TAX', '', $extra_headings); // BMH INVOICE
          if (is_array($extra_headings)) {
              foreach ($extra_headings as $heading_info) {
                  $align = (isset($heading_info['align'])) ? (' text-' . $heading_info['align']) : '';
?>
